...
let ghd = await haikal.sendMessage(m.chat,{video:{url: res.url[0].url}},{quoted:m})
}
break
//=================================================
...
haikal.sendMessage(m.chat, { video: { url: api_response.result[0] }, mimetype: 'video/mp4', fileName: 'instagram.mp4', caption: cap }, m);
}
break
case "twitvideo":{
if (!isCreator) return m.reply('*khusus Premium*')
...
▢ Description: ${desc}
└───────────`
haikal.sendMessage(m.chat, HD, 'twitter.mp4', te, m)
} catch (e) {
